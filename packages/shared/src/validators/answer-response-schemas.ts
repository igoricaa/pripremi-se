...
export type SubmitAnswerResponseInput = z.infer<
...
export type ListAttemptResponsesInput = z.infer<
	typeof listAttemptResponsesSchema
>;
...
export type ListQuestionResponsesInput = z.infer<
	typeof listQuestionResponsesSchema
>;
