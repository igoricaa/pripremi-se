...
export const updateChapterSchema = z.object({
    ...
    slug: z.string().min(1, 'Slug must be at least 1 character').max(100, 'Slug must be less than 100 characters').optional(),
    description: z.string().min(1, 'Description must be at least 1 character').max(500, 'Description must be less than 500 characters').optional(),
